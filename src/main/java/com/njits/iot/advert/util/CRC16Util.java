...
public class CRC16Util {
	...
	public static void main(String[] args) {
		byte[] bytes = ByteUtil.hexStringToByte("0000005100000001210001fca05501020F0000000000210100000031C1C941474C3035300000000031333136323532303831020000000000000000010000007B00000075001E16181112104821");
		byte[] crc = setParamCRC(bytes);
		System.out.println(ByteUtil.bytesToHexString(crc));
	}
